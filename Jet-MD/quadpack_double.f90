...
!
  ...
  real ( kind = 8 ) a,abserr,b,epsabs,epsrel,points,result,work
...
!
  ...
  real ( kind = 8 ) a,abserr,b,epsabs,epsrel,result,work
...
!
  ...
  real ( kind = 8 ) a,aa,abserr,alist,area,area1,area12,area2,a1,a2, &
    ...
    errbnd,errmax,error1,erro12,error2,errsum,result,rlist,uflow
...
!
  ...
  real ( kind = 8 ) a,abserr,b,c,epsabs,epsrel,result,work
  integer ( kind = 4 ) ier,iwork,last,lenw,limit,lvl,l1,l2,l3,neval
  dimension iwork(limit),work(lenw)
...
!
  ...
  real ( kind = 8 ) a,abserr,b,epsabs,epsrel,omega,result,work
...
!
  ...
  real ( kind = 8 ) a,abserr,alfa,alist,area,area1,area12,area2,a1, &
    ...
    epsabs,epsrel,errbnd,errmax,error1,erro12,error2,errsum, &
...
!
  ...
  real ( kind = 8 ) a,abserr,alfa,b,beta,epsabs,epsrel,result,work
...
!
  ...
  real ( kind = 8 ) a,abserr,ak22,amom0,amom1,amom2,b,c,cc,centr, &
    cheb12,cheb24,dqwgtc,fval,hlgth,p2,p3,p4,resabs, &
...
!
  ...
  real ( kind = 8 ) a,abserr,ac,an,an2,as,asap,ass,b,centr,chebmo, &
    ...
    d2,estc,ests,fval,hlgth,oflow,omega,parint,par2,par22, &
...
!
  ...
  real ( kind = 8 ) a,abserr,alfa,b,beta,bl,br,centr,cheb12,cheb24, &
    dc,factor,fix,fval,hlgth,resabs,resasc,result,res12, &
...
!
  ...
  real ( kind = 8 ) a,absc,absc1,absc2,abserr,b,centr,dhlgth, &
    epmach,fc,fsum,fval1,fval2,fv1,fv2,hlgth, &
    p1,p2,p3,p4,resabs,resasc,resg,resk,reskh,result,uflow,wg,wgk, &
    xgk
  integer ( kind = 4 ) j,jtw,jtwm1,kp
  real ( kind = 8 ), external :: f,w
